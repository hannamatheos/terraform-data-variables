resource "aws_instance" "public" {
  ...
  key_name                    = "hanna-key-terra" #Change to your keyname, e.g. jazeel-key-pair
...
resource "aws_security_group" "allow_ssh" {
  name        = "hanna-terraform-security-group" #Security group name, e.g. jazeel-terraform-security-group
